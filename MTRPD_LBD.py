...
# S -> Drone Speed
def create_MTRPD_MP(graph, K, Q, E, S, relax):
    ...
    # Assumptions: L >= 2 todo: build if-else to avoid getting an error
    ...
    model.write(
        'models\\' + "MTRPD_LBD_MP_[Instance = {0}, Drones = {1}, Allowed Nr. of Drone Trips = {2}, Flight Range = {3}].lp".format(
            graph, K, Q, E))
...
def create_MTRPD_SP(graph, K, Q, M, E, S, chosenNodesTruck, chosenArcsTruck, relax):
    ...
    model.write(
        'models\\' + "MTRPD_LBD_SP_[Instance = {0}, Drones = {1}, Allowed Nr. of Drone Trips = {2}, Flight Range = {3}].lp".format(
            graph, K, Q, E))
    # return ralaxed model
    if relax == True:
...
def solve_model_LBD(instancePath, droneSpeed, numberOfDrones, numberOfTrips, largeNumber, efficientSolvingGurobi, relax, optGapStop):
    ...
    while flag:
        if round(U, 5)*optGapStop <= round(L, 5):
            ...
            # plt.show() in the function plot_graph needs to be left out to save the figure
                ...
                if solutionSP == False:
                    ...
                    if modelSP.status == GRB.TIME_LIMIT or modelSP.status == GRB.INTERRUPTED:
                        ...
                        try:
                            ...
                            bounds[it]['globalUpperBound'] = U
                            bounds[it]['optGap'] = round(((U - L) / U) * 100, 4)
                        except:
                            bounds[it]['SPObjectiveValue'] = GRB.INFINITY
                            bounds[it]['globalUpperBound'] = U
                            bounds[it]['optGap'] = round(((U - L) / U) * 100, 4)
...
def main():
    ...
    numberOfTrips = 3 #math.ceil(10/numberOfDrones) # per node per launch customer {1, 2, 3, ..., ceiling(numberOfCustomers/numberOfDrones)}
    ...
    numberOfDrones2 = 3  # {1, 2, 3}
    numberOfTrips2 = 2

    numberOfDrones3 = 3  # {1, 2, 3}
    numberOfTrips3 = 3
    ...
    #     results[instance] = solve_model_LBD(instancePath, droneSpeed, numberOfDrones, numberOfTrips,
    #                                         largeNumber, efficientSolvingGurobi, relax, optGapStop)
    #     fileName = 'DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}\\MTRPD_LBD_uo[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi,_instance_=_{3}]_edit'.format(
    #         droneSpeed, numberOfDrones, numberOfTrips, i)
    #     export_import_Results.exportAllResultsToTextFile(results, fileName)
    #
    # # columnsOverview = ['Instance', 'CPU', 'GAP', 'avCPUMP', 'avCPUSP']
    # # columnsPerInstance = ['Iteration', 'cpuMP', 'cpuSP']
    # fileName = 'MTRPD_LBD_[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi]_edit'.format(droneSpeed, numberOfDrones, numberOfTrips)
    # # # export_import_Results.exportCPUToExcel_LBD(results, columnsOverview, columnsPerInstance, fileName)
    # export_import_Results.exportAllResultsToTextFile(results, fileName)
    #
    ...
    for i in range(10):
        if i == 1:
            ...
            instance = instancePath[10:(len(instancePath) - 4)]
            print('-------> current Instance: ', instance)
            results[instance] = solve_model_LBD(instancePath, droneSpeed, numberOfDrones2, numberOfTrips2,
                                                largeNumber, efficientSolvingGurobi, relax, optGapStop)
            fileName = 'DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}\\MTRPD_LBD_uo[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi,_instance_=_{3}]_edit'.format(
                droneSpeed, numberOfDrones2, numberOfTrips2, i)
            export_import_Results.exportAllResultsToTextFile(results, fileName)
    ...
    #     results[instance] = solve_model_LBD(instancePath, droneSpeed, numberOfDrones2, numberOfTrips2,
    #                                         largeNumber, efficientSolvingGurobi, relax, optGapStop)
    #     fileName = 'DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}\\MTRPD_LBD_co[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi,_instance_=_{3}]_edit'.format(
    #         droneSpeed, numberOfDrones2, numberOfTrips2, i)
    #     export_import_Results.exportAllResultsToTextFile(results, fileName)

    # columnsOverview = ['Instance', 'CPU', 'GAP', 'avCPUMP', 'avCPUSP']
    # columnsPerInstance = ['Iteration', 'cpuMP', 'cpuSP']
    fileName = 'MTRPD_LBD_[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi]_edit'.format(
        droneSpeed, numberOfDrones2, numberOfTrips2)
    # # export_import_Results.exportCPUToExcel_LBD(results, columnsOverview, columnsPerInstance, fileName)
    export_import_Results.exportAllResultsToTextFile(results, fileName)
    ...
    #     instance = instancePath[10:(len(instancePath) - 4)]
    #     print('-------> current Instance: ', instance)
    #     results[instance] = solve_model_LBD(instancePath, droneSpeed, numberOfDrones3, numberOfTrips3,
    #                                         largeNumber, efficientSolvingGurobi, relax, optGapStop)
    #     fileName = 'DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}\\MTRPD_LBD_co[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi,_instance_=_{3}]_edit'.format(
    #         droneSpeed, numberOfDrones3, numberOfTrips3, i)
    #     export_import_Results.exportAllResultsToTextFile(results, fileName)
    #
    # # columnsOverview = ['Instance', 'CPU', 'GAP', 'avCPUMP', 'avCPUSP']
    # # columnsPerInstance = ['Iteration', 'cpuMP', 'cpuSP']
    # fileName = 'MTRPD_LBD_[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi]_edit'.format(
    #     droneSpeed, numberOfDrones3, numberOfTrips3)
    # # # export_import_Results.exportCPUToExcel_LBD(results, columnsOverview, columnsPerInstance, fileName)
    # export_import_Results.exportAllResultsToTextFile(results, fileName)
    ############### end repeat #########################
    #
    #
    # instancePath = r"Instances\clustered-origin-319-n11.txt"
    # instance = instancePath[10:(len(instancePath) - 4)]
    # print('-------> current Instance: ', instance)
    # results[instance] = solve_model_LBD(instancePath, droneSpeed, numberOfDrones, numberOfTrips,
    #                                     largeNumber, efficientSolvingGurobi, relax, optGapStop)
    # fileName = 'MTRPD_LBD_co[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi,_instance_=_{3}]'.format(
    #     droneSpeed, numberOfDrones, numberOfTrips, 9)
    # export_import_Results.exportAllResultsToTextFile(results, fileName)

    # instancePath = r"Instances\line-0-n9.txt"
    # instance = instancePath[10:(len(instancePath) - 4)]
    # print('-------> current Instance: ', instance)
    # results[instance] = solve_model_LBD(instancePath, droneSpeed, numberOfDrones, numberOfTrips,
    #                                     largeNumber, efficientSolvingGurobi, relax, optGapStop)
    # instancePath = r"Instances\line-0-n9 - modified.txt"
    # instance = instancePath[10:(len(instancePath) - 4)]
    # print('-------> current Instance: ', instance)
    # results[instance] = solve_model_LBD(instancePath, droneSpeed, numberOfDrones, numberOfTrips,
    ...
    #                                          largeNumber, efficientSolvingGurobi, relax, optGapStop)
    #
    #     fileName = 'DroneSpeed_=_2,_NrDrones_=_2,_DroneTrips_=_3\\MTRPD_LBD_uc[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi,_instance_=_{3}]'.format(droneSpeed, numberOfDrones, numberOfTrips, i)
    #     export_import_Results.exportAllResultsToTextFile(results, fileName)
    #
    # #uniform origin - 11 nodes
    # for i in range(10):
    ...
    #     results[instance] = solve_model_LBD(instancePath, droneSpeed, numberOfDrones, numberOfTrips,
    #                                          largeNumber, efficientSolvingGurobi, relax, optGapStop)
    #     fileName = 'DroneSpeed_=_2,_NrDrones_=_2,_DroneTrips_=_3\\MTRPD_LBD_uo[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi,_instance_=_{3}]'.format(droneSpeed, numberOfDrones, numberOfTrips, i)
    #     export_import_Results.exportAllResultsToTextFile(results, fileName)
    ...
    #     results[instance] = solve_model_LBD(instancePath, droneSpeed, numberOfDrones, numberOfTrips,
    #                                          largeNumber, efficientSolvingGurobi, relax, optGapStop)
    #     fileName = 'DroneSpeed_=_2,_NrDrones_=_2,_DroneTrips_=_3\\MTRPD_LBD_cc[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi,_instance_=_{3}]'.format(droneSpeed, numberOfDrones, numberOfTrips, i)
    #     export_import_Results.exportAllResultsToTextFile(results, fileName)
    ...
    #     results[instance] = solve_model_LBD(instancePath, droneSpeed, numberOfDrones, numberOfTrips,
    #                                          largeNumber, efficientSolvingGurobi, relax, optGapStop)
    #     fileName = 'DroneSpeed_=_2,_NrDrones_=_2,_DroneTrips_=_3\\MTRPD_LBD_co[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi,_instance_=_{3}]'.format(droneSpeed, numberOfDrones, numberOfTrips, i)
    #     export_import_Results.exportAllResultsToTextFile(results, fileName)
    #
    # # columnsOverview = ['Instance', 'CPU', 'GAP', 'avCPUMP', 'avCPUSP']
    # # columnsPerInstance = ['Iteration', 'cpuMP', 'cpuSP']
    # fileName = 'MTRPD_LBD_[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi]'.format(droneSpeed, numberOfDrones, numberOfTrips)
    # # # export_import_Results.exportCPUToExcel_LBD(results, columnsOverview, columnsPerInstance, fileName)
    # export_import_Results.exportAllResultsToTextFile(results, fileName)
    #
    # ###################################################
    ...
    #                                         largeNumber, efficientSolvingGurobi, relax, optGapStop)
    #
    #     fileName = 'DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}\\MTRPD_LBD_uc[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi,_instance_=_{3}]'.format(
    #         droneSpeed, numberOfDrones2, numberOfTrips2, i)
    #     export_import_Results.exportAllResultsToTextFile(results, fileName)
    #
    # # uniform origin - 11 nodes
    ...
    #     results[instance] = solve_model_LBD(instancePath, droneSpeed, numberOfDrones2, numberOfTrips2,
    #                                         largeNumber, efficientSolvingGurobi, relax, optGapStop)
    #     fileName = 'DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}\\MTRPD_LBD_uo[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi,_instance_=_{3}]'.format(
    #         droneSpeed, numberOfDrones2, numberOfTrips2, i)
    #     export_import_Results.exportAllResultsToTextFile(results, fileName)
    #
    # # clustered centroid - 11 nodes
    ...
    #     results[instance] = solve_model_LBD(instancePath, droneSpeed, numberOfDrones2, numberOfTrips2,
    #                                         largeNumber, efficientSolvingGurobi, relax, optGapStop)
    #     fileName = 'DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}\\MTRPD_LBD_cc[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi,_instance_=_{3}]'.format(
    #         droneSpeed, numberOfDrones2, numberOfTrips2, i)
    #     export_import_Results.exportAllResultsToTextFile(results, fileName)
    #
    # # clustered origin - 11 nodes
    ...
    #     results[instance] = solve_model_LBD(instancePath, droneSpeed, numberOfDrones2, numberOfTrips2,
    #                                         largeNumber, efficientSolvingGurobi, relax, optGapStop)
    #     fileName = 'DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}\\MTRPD_LBD_co[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi,_instance_=_{3}]'.format(
    #         droneSpeed, numberOfDrones2, numberOfTrips2, i)
    #     export_import_Results.exportAllResultsToTextFile(results, fileName)
    #
    # # columnsOverview = ['Instance', 'CPU', 'GAP', 'avCPUMP', 'avCPUSP']
    # # columnsPerInstance = ['Iteration', 'cpuMP', 'cpuSP']
    # fileName = 'MTRPD_LBD_[DroneSpeed_=_{0},_NrDrones_=_{1},_DroneTrips_=_{2}_efficientSolvingGurobi]'.format(
    #     droneSpeed, numberOfDrones2, numberOfTrips2)
    # # # export_import_Results.exportCPUToExcel_LBD(results, columnsOverview, columnsPerInstance, fileName)
    # export_import_Results.exportAllResultsToTextFile(results, fileName)
